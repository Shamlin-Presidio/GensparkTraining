...
#     response = answers.get(pred, "Sorry, I don't understand that question. Arranging a connect with our support desk")
...
def answer_question():
    ...
    if max_prob < 0.3:
        response = "Sorry, I don't understand that question. Arranging a connect with support desk."
    else:
        pred = clf.predict(vec)[0]
        response = answers.get(pred, "Sorry, I don't understand that question. Arranging a connect with support desk.")
